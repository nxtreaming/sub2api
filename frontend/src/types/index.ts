...
export type GroupPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'kimi'
...
export type AccountPlatform = 'anthropic' | 'openai' | 'gemini' | 'antigravity' | 'minimax' | 'kimi'
