...
export type Platform = 'anthropic' | 'openai' | 'antigravity' | 'gemini' | 'minimax' | 'kimi'
...
const BADGE: Record<Platform, string> = {
  ...
  minimax: 'bg-cyan-500/10 text-cyan-600 border-cyan-500/30 dark:text-cyan-400',
  kimi: 'bg-rose-500/10 text-rose-600 border-rose-500/30 dark:text-rose-400',
}
...
const BADGE_LIGHT: Record<Platform, string> = {
  ...
  minimax: 'bg-cyan-500/10 text-cyan-600 dark:bg-cyan-500/10 dark:text-cyan-300',
  kimi: 'bg-rose-500/10 text-rose-600 dark:bg-rose-500/10 dark:text-rose-300',
}
...
const BORDER: Record<Platform, string> = {
  ...
  kimi: 'border-rose-500/20 dark:border-rose-500/20',
}
...
const ACCENT_BAR: Record<Platform, string> = {
  ...
  kimi: 'bg-gradient-to-r from-rose-400 to-rose-500',
}
...
const TEXT: Record<Platform, string> = {
  ...
  minimax: 'text-cyan-600 dark:text-cyan-400',
  kimi: 'text-rose-600 dark:text-rose-400',
}
...
const ICON: Record<Platform, string> = {
  ...
  minimax: 'text-cyan-500 dark:text-cyan-400',
  kimi: 'text-rose-500 dark:text-rose-400',
}
...
const BUTTON: Record<Platform, string> = {
  ...
  minimax: 'bg-cyan-500 text-white hover:bg-cyan-600 active:bg-cyan-700 dark:bg-cyan-500/80 dark:hover:bg-cyan-500',
  kimi: 'bg-rose-500 text-white hover:bg-rose-600 active:bg-rose-700 dark:bg-rose-500/80 dark:hover:bg-rose-500',
}
...
const DISCOUNT: Record<Platform, string> = {
  ...
  kimi: 'bg-rose-100 text-rose-700 dark:bg-rose-900/40 dark:text-rose-300',
}
...
const GRADIENT: Record<Platform, string> = {
  ...
  kimi: 'from-rose-500 to-rose-600',
}
...
function isPlatform(p: string): p is Platform {
  return p === 'anthropic' || p === 'openai' || p === 'antigravity' || p === 'gemini' || p === 'minimax' || p === 'kimi'
}
